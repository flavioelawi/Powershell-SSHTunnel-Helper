    ...
    $TextBox1.width                  = 272
    $TextBox1.height                 = 20
    $TextBox1.location               = New-Object System.Drawing.Point(69,78)
    ...
    $Label1.width                    = 25
    $Label1.height                   = 10
    $Label1.location                 = New-Object System.Drawing.Point(136,54)
    ...
    $RadioButton1.location           = New-Object System.Drawing.Point(63,162)
    ...
    $RadioButton2.location           = New-Object System.Drawing.Point(80,180)
    ...
    $MaskedTextBox1.location         = New-Object System.Drawing.Point(100,250)
    ...
    $Form.controls.AddRange(@($TextBox1,$Label1,$RadioButton1,$Button1,$MaskedTextBox1))
